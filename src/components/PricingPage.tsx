              ...
              >
                ...
                <div className="p-8">
                  ...
                  <button
                    ...
                    className={`relative bottom-0 w-full py-4 px-6 rounded-xl font-semibold text-sm transition-all duration-200 flex items-center justify-center space-x-2 mt-full ${
